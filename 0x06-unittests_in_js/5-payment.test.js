...
describe('sendPaymentRequestToApi', () => {
  ...
  it('Function sendPaymentRequestToApi(100, 20) logs "The total is: 120" to system console', () => {
    sendPaymentRequestToApi(100, 20);
    expect(bigBrother.log.calledWith('The total is: 120')).to.be.true;
    expect(bigBrother.log.calledOnce).to.be.true;
  });

  it('Function sendPaymentRequestToApi(10, 10) logs "The total is: 20" to system console', () => {
